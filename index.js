...
const BotName = 'M⃗R⃗ K⃗I⃗N⃗G⃗ V⃗I⃗P⃗ ';
const wa = 'BELUM TERSEDIA';
const eror = 'Info fitur Error';
const ow = 'MྂRྂ KྂIྂNྂGྂ';
const nomorowner = '18313535216';
const ovo = 'BELUM TERSEDIA';
const pulsa = 'BELUM TERSEDIA';
const dana = 'BELUM TERSEDIA';
const instagram = 'BELUM TERSEDIA';
